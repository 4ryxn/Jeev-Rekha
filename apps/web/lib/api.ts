...
export interface Advisory { id: number; consignment_id: number; data_source: LocationDataSource; risk_state: RiskState; evidence_coverage_score: number; reasons: { code: string; text: string }[]; evidence_factors: EvidenceFactor[]; recommended_action: string; evaluated_at: string; rules_version: string; consignment: Consignment }
