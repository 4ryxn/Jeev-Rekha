...
export type ReviewCaseType = "evidence_gap" | "sync_exception" | "trace_contact" | "lab_referral";
export type SampleStatus = "none" | "collected" | "sent_to_lab" | "result_received";
export interface ReviewCase {id:number;source_type:string;source_id:string;category:ReviewCaseType;case_type:ReviewCaseType;sample_status:SampleStatus;priority:"high"|"medium"|"low";title:string;summary:string;status:"open"|"acknowledged"|"resolved";resolution_note:string|null;created_at:string;acknowledged_at:string|null;resolved_at:string|null;source_summary:string;source_href:string;data_source?:LocationDataSource}
export interface ReportIndex {advisories:{id:number;href:string;title:string;data_source:LocationDataSource}[];traces:{id:number;href:string;title:string;data_source:LocationDataSource}[];containment:{id:number;href:string;title:string;data_source:LocationDataSource}[];lab_referrals:{id:number;href:string;title:string;data_source:LocationDataSource}[]}
