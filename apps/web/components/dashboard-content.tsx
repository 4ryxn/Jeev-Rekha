...
export function DashboardContent() {
  ...
  useEffect(() => {
    Promise.all([apiFetch<Outbreak[]>(sourcePath("/outbreaks", context)), apiFetch<Consignment[]>(sourcePath("/consignments", context)), apiFetch<Advisory[]>(sourcePath("/advisories", context))])
