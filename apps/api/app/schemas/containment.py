...
class ContainmentRead(BaseModel):
 ...
 id:int; outbreak:OutbreakRead; data_source:LocationDataSource; horizon_days:int; selected_actions:list[str]; baseline_summary:dict[str,object]; scenario_summary:dict[str,object]; assumptions:list[str]; created_at:datetime
